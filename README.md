...
-
These Ai have been worked on for the past 3000+ Hours it is not finished some are Deprecated and not Maintained.
-
Note: THERE WILL BE MANY ISSUES NOT FULLY FIXED! Do not be toxic about the bot! Only Helpful Comments will be welcomed!
I know everything that is wrong with these AIs and Live Version of Barbarian. Do not flood the AI Chat with nonsense.
-
What AI do What:
-
Barb3
...
C:\Program Files\Beyond-All-Reason\data\engine\$VERSION\AI\Skirmish
...
-
AI INFO (Barb3/Barb4/Barb5~)::
-
Armada:
-
1. 100% Coded
2. Fixes Needed:
3. Nuclear Over Clear
4. T3 > Nuke Spam > 30mins
5. Front/Fronttech > Disable Nukes
6. Sea T2 to Amphib Assault stuck on Sea to long w/ out pressure
-
Cortex:
-
1. 100% Coded
...
-
1. Jammers are still a shit way to play
2. Junos not Firing
3. Air turned off AI AFK for AIR Role.
-
