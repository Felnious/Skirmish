...
--	{ -- string armvp+armhp+corvp+corhp+legvp+leghp+armap+corap+legap
--		key     = 'json',
--		name    = 'JSON',
--		desc    = 'Per-AI config.\nkey: json',
--		type    = 'string',
		...
		items   = {
			{
				...
				desc = 'Nightmare by | Felnious AI Developer',
			},
			{
				key  = 'Nuclear',
				name = 'Nuclear Config',
				desc = 'Nuclear by | Felnious AI Developer',
			},
			{
				key  = 'Aircraft',
				name = 'Aircraft Config',
				desc = 'Aircraft by | Felnious AI Developer',
			},
			{
				key  = 'Sea',
				name = 'Sea Config',
				desc = 'Sea by | Felnious AI Developer',
			},
		},
	},
}
